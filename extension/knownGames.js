...
function createViewportFromScreenshot(fieldLogicalWidth, screenshotWidth, fieldLeft, fieldRight, fieldTop) {
    ...
    return `@vp ${-Math.round(logicalLeft)} ${-Math.round(logicalTop)} ${Math.round(logicalRight)} ${Math.round(logicalBottom)}`;
}